...
urlpatterns = [
    ...
    # Student
    path('student/getAllStudents/', views.get_all_students, name='getAllStudents'), # Get All Students api
    ...
    path('student/team/leaderboard/', views.StudentLeaderboardPageView.as_view(), name='StudentLeaderboard'),
	path('student/user/', views.StudentUserPageView.as_view(), name='StudentUser'),
	...
	path('team/getLeaderboard', views.get_leaderboard, name='getLeaderboard'),
